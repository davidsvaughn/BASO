...
class MultitaskGPSequentialSampler:
    def __init__(self, num_tasks, rank, training_iterations=100, learning_rate=0.1, beta=0.05):
    ...
    def fit(self, train_x, train_t, train_y):
        ...
        # Use the adam optimizer
        optimizer = torch.optim.Adam(self.model.parameters(), lr=self.learning_rate)  # Includes GaussianLikelihood parameters
